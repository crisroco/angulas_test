...
export class LoginComponent implements OnInit {
  ...
  public usersAdmin = ["AFARFANP","BENCISO","DALARCONU","EMORAN","TLOZANO","SLOZADA","JSOLANOB","YTENORIO","BROLDANSA","JLEON","ACORNEJOC","JODIAGA","LYUCRAA","MFALCONU","PLOVATON","VYLLESCAS","RMUNOZRA","WALVA","GMENDEZ","JCRUCESP","LESPINOZA","LYAYA","LMANUCCI"];
