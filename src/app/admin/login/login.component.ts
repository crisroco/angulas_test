...
export class LoginComponent implements OnInit {
  ...
  public usersAdmin = ["SOBREGON","TLOZANO","JLEON","DALARCONU","EMORAN","PFERRUA","SLOZADA","MNOBLECILLA","BROLDANSA","AJAUREGUIA","YTENORIO","BENCISO","AFARFANP","WALVA","JCRUCESP","JSOLANOB", "LCARRANZAM","GALVARADOT","EACOSTAC"];
