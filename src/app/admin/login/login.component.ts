...
export class LoginComponent implements OnInit {
  ...
  public usersMatricula = ["SLEONA","CCIEZA","ACORNEJOC","BRAMIREZ","APALOMINO","BBARRIOSA"];
  public usersMiPortal = ["DOBANDO","MFALCON","AMOLINAP","ANERYFI","CARISACA","CPENAS","DGONZALESC","EBARRAZA","GGARCIAPOR","GFLORESR","IRUIZ","JGRAU","LPAULETT","LQUIROS","MVELARDEM","MMONTEJO","OROSALES","OSUMAR","CCASTROPEREZ","SMEZAB","SVALLE","RMORALESTO","JODIAGA","MFALCONU","PLOVATON","VYLLESCAS","RMUNOZRA","GMENDEZ","MSEGURACA","LESPINOZA","LMANUCCI"];
  public usersAdmin = ["LYAYA","SOBREGON","TLOZANO","JLEON","DALARCONU","EMORAN","PFERRUA","SLOZADA","MNOBLECILLA","BROLDANSA","AJAUREGUIA","YTENORIO","BENCISO","AFARFANP","WALVA","JCRUCESP","JSOLANOB", "LCARRANZAM","GALVARADOT","EACOSTAC", "AJAUREGUIA", "JLEON", "SOBREGON","BBARRIOSA"];
