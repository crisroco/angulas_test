...
export class LoginComponent implements OnInit {
  ...
  public usersMiPortal = ["MFALCON","AMOLINAP","ANERYFI","CARISACA","CPENAS","DGONZALESC","EBARRAZA","GGARCIAPOR","GFLORESR","IRUIZ","JGRAU","LPAULETT","LQUIROS","MVELARDEM","MMONTEJO","OROSALES","OSUMAR","CCASTROPEREZ","SMEZAB","SVALLE","RMORALESTO"];
