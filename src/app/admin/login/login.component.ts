...
export class LoginComponent implements OnInit {
  ...
  public usersMatricula = [];
  public usersMiPortal = [];
  public usersAdmin = ["AFARFANP","BENCISO","DALARCONU","EMORAN","TLOZANO","SLOZADA","JSOLANOB","GDURANDP","SLEONA","JLUQUEC","YTENORIO","BROLDANSA","JLEON","ACORNEJOC","JODIAGA","LYUCRAA","MFALCONU","PLOVATON","VYLLESCAS","RMUNOZRA","WALVA","GMENDEZ","JCRUCESP","LESPINOZA","LYAYA","LMANUCCI"];
