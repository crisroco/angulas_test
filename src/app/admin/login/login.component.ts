...
export class LoginComponent implements OnInit {
  ...
  variable: string = '';
  student: any;
  public opridsList = ['BENCISO', 'EMORAN', 'AFARFANP', 'WALVA','JCRUCESP', 'TLOZANO','DALARCONU', 'BROLDANSA', 'SLEONA','CCIEZA','ACORNEJOC','BRAMIREZ','APALOMINO','BBARRIOSA', 'JSOLANOB', 'LYAYA', 'CGRANDAC'];
