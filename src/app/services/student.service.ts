...
export class StudentService {
    ...
    public getLinkZoom(cicle, myclass, date, teacher, section): Promise<any> {
        return this.http.get("https://aulavirtualcpe.cientifica.edu.pe/mod/zoom/client/zoom_link.php?strm=" + cicle + '&nbr=' + myclass + '&date=' + date + '&teacher=' + teacher + '&section=' + section, {responseType: 'text'}).toPromise();
    }
