...
export class IntentionService {
    ...
    public getParameters(emplid = '1'): Promise<any> {
        return this.http.get(AppSettings.BASE + AppSettings.INTENTION + '/getParameters/' + emplid, { headers: this.generalS.makeHeaderNormal()}).toPromise();
    }
